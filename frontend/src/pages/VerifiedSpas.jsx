        ...
        {loading ? (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {spas.map((spa) => (
                <div key={spa.id} className="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="p-6">
                    {/* SPA Name */}
                    <div className="mb-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600 break-all">{spa.email}</span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">{spa.phone}</span>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <span className="text-sm text-gray-600 leading-relaxed">{spa.address}</span>
                      </div>
                    </div>
